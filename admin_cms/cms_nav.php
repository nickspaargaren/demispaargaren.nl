...
<div class="cms_navHolder">
	<ul class="cms_nav">
		<li class="item <?php echo $cms_pagina_titel === 'Dashboard' ? 'active' : '' ?>"><a href="dashboard.php"><i class="fa fa-home"></i><span class="titel">Home</span>
				<div class="cleared"></div>
			</a></li>
		<li class="item <?php echo $cms_pagina_titel === 'Pagina\'s' ? 'active' : '' ?>"><a href="paginas.php"><i class="fa fa-sitemap"></i><span class="titel">Pagina's</span>
				<div class="cleared"></div>
			</a></li>
		<li class="item <?php echo $cms_pagina_titel === 'Afbeeldingen' ? 'active' : '' ?>"><a href="afbeeldingen.php"><i class="fa fa-image"></i><span class="titel">Afbeeldingen</span>
				<div class="cleared"></div>
			</a></li>
		...
		<li class="item <?php echo $cms_pagina_titel === 'Social Media' ? 'active' : '' ?>"><a href="socialmedia.php"><i class="fa fa-share-alt"></i><span class="titel">Social Media</span>
				<div class="cleared"></div>
			</a></li>
		<li class="item <?php echo $cms_pagina_titel === 'Instellingen' ? 'active' : '' ?>"><a href="instellingen.php"><i class="fa fa-gear"></i><span class="titel">Instellingen</span>
				<div class="cleared"></div>
			</a></li>
		<li class="item <?php echo $cms_pagina_titel === 'Hulp' ? 'active' : '' ?>"><a href="hulp.php"><i class="fa fa-info"></i><span class="titel">Hulp</span>
				<div class="cleared"></div>
			</a></li>
		<?php
