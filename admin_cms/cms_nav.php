	...
	<div class="cms_extranav">
		...
		<div class="account">
			...
			<ul class="submenu">
				...
				<?php if($forms_unread > 0){echo '<li><a href="formulier.php">Meldingen <span class="formAantal">' . $forms_unread . '</span></a></li>';} ?>
...
<div class="cms_navHolder">
	<ul class="cms_nav">
		...
		<li class="item <?php echo $cms_pagina_titel === 'Contactformulier' ? 'active' : '' ?>"><a href="formulier.php"><?php if($forms_unread > 0){echo '<div class="formAantal">' . $forms_unread . '</div>';} ?><i class="fa fa-file-text-o"></i><span class="titel">Contactformulier</span><div class="cleared"></div></a></li>
